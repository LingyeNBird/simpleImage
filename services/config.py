...
def _load_settings() -> LoadedSettings:
    ...
    refresh_interval = _coerce_int(raw_config.get("refresh_account_interval_minute", 60), 60)
...
class ConfigStore:
    ...
    @property
    def redeem_keys_file(self) -> Path:
        return DATA_DIR / "redeem_keys.json"

    @property
    def refresh_account_interval_minute(self) -> int:
        return _coerce_int(self.data.get("refresh_account_interval_minute", 60), 60)
