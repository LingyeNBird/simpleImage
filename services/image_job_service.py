...
def _normalize_job(raw: object) -> dict[str, object] | None:
    ...
    response_options = normalize_image_response_options(
        ...
        raw.get("response_main_model"),
        raw.get("response_tool_model"),
        raw.get("response_instructions"),
        raw.get("response_reasoning_effort"),
        raw.get("response_reasoning_summary"),
        raw.get("response_parallel_tool_calls"),
        raw.get("response_include_encrypted_reasoning"),
        raw.get("response_store"),
        raw.get("response_partial_images"),
        raw.get("response_tool_choice"),
    )
    return {
        "id": job_id,
